  ...
  return (
    <div className={'relative group'} aria-describedby={id}>
      ...
      <div
        ...
        role={'tooltip'}
        className={cn(
          'absolute top-8 w-[200px] transition-opacity ease-in duration-200 opacity-0 hidden group-hover:block group-hover:opacity-100 max-sm:group-active:opacity-100 z-50',
          {
